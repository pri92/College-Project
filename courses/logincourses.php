...
<li><a href="phpquiz.php" ><option onClick="show(this.value)" value="php" >PHP</option></a></li>
<br>
<li><a href="cquiz.php"><option onClick="show(this.value)" value="c" >C</option></a></li>
<br>
<li><a href="htmlquiz.php"><option onClick="show(this.value)" value="html" >HTML</option></a></li>
<br>
<li><a href="aptitudequiz.php"><option onClick="show(this.value)" value="aptitude" >APTITUDE</option></a></li>
</ul>
</li>
                  <li><a href="../result.php" onclick="show(this.value)" value="result">More</a></li>
